<template>
  <div class="space-y-4">
    ...
    <!-- Modal -->
    <AppModal :show="showModal" :title="editingBrand ? 'Edit Brand' : 'Add Brand'" @close="closeModal">
    ...
    <!-- Delete Confirm -->
    <AppModal :show="showConfirm" title="Delete Brand" max-width="max-w-sm" @close="showConfirm = false">
